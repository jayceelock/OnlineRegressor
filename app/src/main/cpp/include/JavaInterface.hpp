...
JNIEXPORT void JNICALL Java_com_activis_jaycee_onlineregressor_JNINativeInterface_playBand(JNIEnv* env, jobject obj, jfloat offset, jboolean play, jfloat pitch);
